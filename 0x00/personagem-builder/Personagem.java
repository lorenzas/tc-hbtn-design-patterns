...
public abstract class Personagem {
    ...
    public boolean equals(Object o) {
        ...
        return getInteligencia() == that.getInteligencia() && getForca() == that.getForca() && getVigor() == that.getVigor() && getResistencia() == that.getResistencia() && getDestreza() == that.getDestreza() && getNome().equals(that.getNome()) && getTipo() == that.getTipo();
    }

    @Override
    public int hashCode() {
        return Objects.hash(getNome(), getTipo(), getInteligencia(), getForca(), getVigor(), getResistencia(), getDestreza());
    }
